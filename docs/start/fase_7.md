...
**Criterio de aceite:**
- [ ] Snooze thread com opcoes pre-definidas
- [ ] Snooze com data/hora custom (date picker)
- [ ] Thread desaparece do inbox ao snooze
- [ ] Thread reaparece no topo ao despertar
- [ ] Thread marcado como unread ao despertar
- [ ] Notificacao ao despertar
- [ ] Lista de threads snoozed acessivel
- [ ] Unsnooze (cancelar snooze)
- [ ] Atalho: `b` no thread list
...
**Criterio de aceite:**
- [ ] Agendar envio com opcoes pre-definidas
- [ ] Agendar com data/hora custom
- [ ] Draft marcado como "scheduled" (visual distinto)
- [ ] Email enviado automaticamente no horario
- [ ] Cancelar agendamento
- [ ] Editar draft agendado (cancela e reagenda)
- [ ] Notificacao ao enviar
- [ ] Funciona com app fechado (backend Tauri persiste)
...
- [ ] Snooze funcional (snooze, wake-up, notifications)
