...
const fallbackMessagesById: Record<string, MessageRecord> = {
  msg_1: {
    id: 'msg_1',
    account_id: 'acc_demo',
    thread_id: 'thr_1',
    ...
    headers: {
      'x-open-mail-source': 'design-review'
    },
    created_at: '2026-03-13T10:00:00Z',
    updated_at: '2026-03-13T10:00:00Z'
  },
  msg_2: {
    ...
    attachments: [],
    headers: {
      'x-open-mail-source': 'tauri-health'
    },
    created_at: '2026-03-13T10:00:00Z',
    updated_at: '2026-03-13T10:00:00Z'
  },
  ...
  useQuery({
    ...
    queryFn: async () => {
      ...
      if (!tauriRuntime.isAvailable()) {
        return fallbackMessagesById[messageId] ?? null;
      }
